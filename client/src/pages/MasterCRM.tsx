...
const PipelineView = ({
  ...
  .filter((l) => l.dados.crm?.status === stage.id)
  .sort((a, b) => {
  if (orderByMargem) {
    const ma = a.dados.margem_consignavel ?? 0;
    const mb = b.dados.margem_consignavel ?? 0;
    return mb - ma; // maior margem em cima
  }
